#!/bin/bash
# Reference https://tldp.org/LDP/abs/html/parameter-substitution.html
set -euo pipefail
...
# Bash substitution #
#####################
ex="${1:-defaultValue}"               # If $1 not decleared or is empty use defaultValue
ex="${1:+defaultValue}"               # If $1 is set and is not empty use defaultValue, else use null string
